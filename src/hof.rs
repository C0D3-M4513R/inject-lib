...
#[inline]
pub(crate) fn optpredicate<I,I2,IO,O>(fi:impl Fn(I) -> Option<IO>, o:impl Fn(IO,I2)->O) -> impl Fn(I,I2) -> Option<O>{
	move |i,i2|{
		fi(i).map(|io|o(io,i2))
	}
}
...
//todo: does this bring a performance benefit?
#[inline]
pub(crate) fn prepredicate<I,I2,IO,I2O,O>(fi:impl Fn(I) -> IO,fi2:impl Fn(I2)-> I2O, o:impl Fn(IO,I2O)->O) -> impl Fn(I,I2) -> O {
	move |i,i2|{
		o(fi(i),fi2(i2))
	}
}